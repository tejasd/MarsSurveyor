function  untouched = survey_orig(map,initialstate,instructions,varargin)
...
[numberoftimesteps, numberofrovers] = size(instructions);
...
for rover = 1:numberofrovers
   ...
   qx = PA(:,1) + c(rover)-0.5; qy = PA(:,2) + r(rover)-0.5;
